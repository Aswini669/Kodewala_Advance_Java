...
public class RedisConfig {
	...
	public RedisConnectionFactory redisConnectionFactory() {
		...
		RedisStandaloneConfiguration redisConfig = new RedisStandaloneConfiguration("cuddly-rabbit-27579.upstash.io",
				6379);
		redisConfig.setUsername("default");
		redisConfig.setPassword("AWu7AAIncDFmOTU2YzA5Y2Y5NWI0MTQzOWZkNGZjNzQ0NDAwMmFkNXAxMjc1Nzk");
